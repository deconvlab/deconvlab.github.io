...
Generally speaking, if the spectrum of the short $\mathbf a_0$ is biased ($\mathbf a_0$ is lowpass, highpass, etc.), then the coherence of $\mathbf a_0$ tends to become larger, and vice versa.
